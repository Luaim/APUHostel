    ...
    <body>
        <div class="container">
            ...
            <div class="error-message">
                ...
                <p style="color: red;">🚫 Your account has been blocked due to multiple failed login attempts.</p>
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                ...
                <% } else if (request.getAttribute("error").equals("role")) { %>
                <p style="color: red;">⚠ Role not recognized.</p>
            ...
            <% } else { %>
            <p style="color: red; text-align: center;">❌ Signup failed, please try again.</p>
            <% }
                }%>
            ...
            <div class="form-container" id="signup-form">
                <!-- Signup Messages (Inside Signup Form) -->
                <% if (request.getAttribute("signupMessage") != null) {%>
                <p class="<%= request.getAttribute("signupMessageType").equals("success") ? "success-message" : "error-message"%>">
                ...
                <form action="SignupServlet" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="email" name="email" placeholder="Email" required>
                    <input type="number" id="phone_number" name="id" placeholder="ID" required oninput="validatePhoneNumber(this)">
