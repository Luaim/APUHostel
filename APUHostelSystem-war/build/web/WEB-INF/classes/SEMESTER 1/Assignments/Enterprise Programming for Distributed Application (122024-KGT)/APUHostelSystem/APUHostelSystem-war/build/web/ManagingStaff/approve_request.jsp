...
<head>
    ...
    <link rel="stylesheet" href="approve_request.css"> <!-- ✅ Your CSS file -->
    ...
    <script>
        ...
        function searchTable() {
            ...
            tableRows.forEach(row => {
                let name = row.cells[2].innerText.toLowerCase().trim();
                let email = row.cells[3].innerText.toLowerCase().trim();
                let purpose = row.cells[9].innerText.toLowerCase().trim();

                if (name.includes(input) || email.includes(input) || purpose.includes(input)) {
                    row.style.display = "";
                } else {
