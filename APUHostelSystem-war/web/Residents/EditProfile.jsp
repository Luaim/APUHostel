...
<html>
    <head>
        ...
        <title>Residents - Edit Profile</title>

        <!-- External Styles & Scripts -->
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Residents/Residents.css">
            ...
            <div class="sidebar">
                <div class="profile-section">
                    ...
                    <button id="editProfileBtn" class="edit-profile" 
                            onclick="location.href = '${pageContext.request.contextPath}/Residents/Residents.jsp'">
